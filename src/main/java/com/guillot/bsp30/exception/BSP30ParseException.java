...
*/
package com.guillot.bsp30.exception;

public class BSP30ParseException extends Exception {

    private static final long serialVersionUID = 9131633980394126787L;

    public BSP30ParseException(String message) {
        super(message);
    }
}
